    ...
    <div>
        ...
        <div class="page-container">
            <div class="page" v-if="u.data.uid && galleries[0]">
                <h1>
                    <div>New Post</div>
                    <small v-html="galleries[0].title"></small>
                </h1>
                <div id="gallery-prompt" v-html="galleries[0].prompt"></div>
                <div>Title</div>
                ...
                <br>
                <textarea v-if="submission.text!=null" v-on:input="updateSub('text',$event)"></textarea>
                <input v-if="submission.link!=null" v-on:input="updateSub('link',$event)">
                ...
                <hr>
                <div class="button" v-on:click="submit">Submit</div>
